"""
Complaint Priority Orchestration System  FastAPI Application Entry Point.
This module initializes the FastAPI app, configures CORS and static files,
registers route modules, creates database tables, and seeds the admin user.
"""
import os
